...
class Client:
    ...
    def establishConnection(self):
        ...
        match retMsg:
            ...
            case "connection successful":
                self.sock.send(self.cPort.to_bytes(10, byteorder ='big'))
    ...
    def fetchClients(self):
        ...
        for i in clts:
            if i[0] != self.name:
                self.otherClients.append([i[0], i[1], bytes.fromhex(i[2]), i[3]])
